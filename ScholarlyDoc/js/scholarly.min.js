!function e(t, s, a) {
    ...
    1: [function (e, t, s) {
        ...
        function o() {
            Array.from(document.querySelectorAll("section")).forEach(function (e) {
                var t = i(e), s = e.firstElementChild, a = "h" + (t > 6 ? 6 : t);
                if (s.localName !== a) {
            ...
            var e = r(document.body, [0]), t = document.querySelector('div[role="contentinfo"]');
        ...
        function r(e, t) {
            ...
            return a.setAttribute("role", "directory"), s.forEach(function (e) {
                ...
                if (s && /^h[2-6]$/.test(s.localName)) {
                    ...
                    if (o) {
                        t[t.length - 1]++;
                        var i = t.slice(), n = i.join("."), c = 1 === i.length;
                        c && (n += ".");
        ...
        function c() {
            var e = document.createElement("dl"), t = {};
            ...
            var s = document.createElement("section"), a = document.createElement("h2");
        ...
        var p = e("@scienceai/scholarly-article"), m = (a(p), e("./refs")), h = a(m),
    ...
    }, {"./refs": 1, "@scienceai/scholarly-article": 3}], 3: [function (e, t, s) {
        t.exports = e("./scholarly-article.json")
    }, {"./scholarly-article.json": 4}], 4: [function (e, t, s) {
        t.exports = {
            "@context": {
